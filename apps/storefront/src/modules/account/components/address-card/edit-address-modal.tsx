    ...
    <>
      <div
        className={clx(
          ...
          {
            "border-[var(--pi-border-strong)]": isActive,
          }
        )}
      ...
      >
        ...
        <div className="flex items-center gap-x-4">
          <button
            className="flex items-center gap-x-2 text-small-regular text-ui-fg-base transition-colors hover:text-grey-90"
            onClick={open}
      ...
      <Modal isOpen={state} close={close} data-testid="edit-address-modal">
        <Modal.Title>
          <Heading className="mb-2">{messages.account.editAddress}</Heading>
        </Modal.Title>
