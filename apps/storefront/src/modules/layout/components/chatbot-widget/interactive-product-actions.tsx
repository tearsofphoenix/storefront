...
export default function ChatbotInteractiveProductActions({
  ...
  if (!product) {
    return (
      <div className="mt-4 flex h-9 w-full animate-pulse items-center justify-center border border-[var(--pi-border)] bg-[var(--pi-surface-soft)] text-xs text-[#6b7280]">
  ...
  return (
    <div className="mt-4 flex flex-col gap-y-3">
      ...
      <Button
        ...
        variant="primary"
        className="h-9 w-full !rounded-none !border-[var(--pi-primary)] !bg-[var(--pi-primary)] text-xs !text-white hover:!border-[var(--pi-primary-hover)] hover:!bg-[var(--pi-primary-hover)]"
        isLoading={isAdding}
      >
        {isSuccess
