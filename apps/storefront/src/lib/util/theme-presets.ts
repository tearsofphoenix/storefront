...
const PRESET_DEFINITIONS = [
  ...
  },
  {
    ...
    name: "Porto",
    tier: "deep-special",
    summary: "Enterprise density and B2B-ready catalog",
    primaryColor: "#0088cc",
    accentColor: "#e7f3f9",
    buttonFillColor: "#0088cc",
    buttonTextColor: "#ffffff",
    headingStyle: "sans",
    headingFontFamily: '"Oswald", "Arial Narrow", "Helvetica Neue", Arial, sans-serif',
    bodyFontFamily: '"Hind", "Open Sans", "Helvetica Neue", Arial, sans-serif',
