...
const PRESET_DEFINITIONS = [
  ...
  },
  {
    ...
    name: "WoodMart",
    tier: "deep-special",
    summary: "Dark furniture and home commerce",
    primaryColor: "#c8975a",
    accentColor: "#3b3128",
    buttonFillColor: "#c8975a",
    buttonTextColor: "#1a1713",
    headingStyle: "sans",
    headingFontFamily: '"Poppins", Arial, sans-serif',
    bodyFontFamily: '"Poppins", Arial, sans-serif',
    shellBackground: "#1a1713",
    navBackground: "rgba(26, 23, 19, 0.94)",
    footerBackground: "#241f1a",
  },
  {
    key: "minimal",
    slug: "minimal",
