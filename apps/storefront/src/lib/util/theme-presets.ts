...
const PRESET_DEFINITIONS = [
  ...
  },
  {
    ...
    name: "Symmetry",
    tier: "deep-special",
    summary: "Boutique merchandising with color-blocked zones",
    primaryColor: "#2c2c2c",
    accentColor: "#d4b896",
    buttonFillColor: "#2c2c2c",
    buttonTextColor: "#f5f5f5",
    headingStyle: "serif",
    headingFontFamily: '"Libre Baskerville", Georgia, serif',
    bodyFontFamily: '"Libre Franklin", "Helvetica Neue", Arial, sans-serif',
    shellBackground: "#faf7f4",
    navBackground: "rgba(250, 247, 244, 0.95)",
    footerBackground: "#efe5d7",
  },
  {
    key: "minimal",
    slug: "minimal",
