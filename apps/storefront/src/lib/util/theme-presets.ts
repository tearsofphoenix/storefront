...
const PRESET_DEFINITIONS = [
  ...
  },
  {
    ...
    name: "Turbo",
    tier: "vertical-killer",
    summary: "Fast browsing with dense merchandising",
    primaryColor: "#3b82f6",
    accentColor: "#dbeafe",
    buttonFillColor: "#3b82f6",
    buttonTextColor: "#ffffff",
    headingStyle: "sans",
    headingFontFamily: '"Proxima Nova", "Inter", Arial, sans-serif',
    bodyFontFamily: '"Proxima Nova", "Inter", Arial, sans-serif',
  ...
  },
  {
    ...
    name: "Flatsome",
    tier: "vertical-killer",
    summary: "WooCommerce builder-style storefront",
    primaryColor: "#4e9af1",
    accentColor: "#dbeafe",
    buttonFillColor: "#2e6ecf",
    buttonTextColor: "#ffffff",
    headingStyle: "sans",
    headingFontFamily: '"Lato", "Open Sans", Arial, sans-serif',
    bodyFontFamily: '"Lato", "Open Sans", Arial, sans-serif',
    shellBackground: "#ffffff",
    navBackground: "rgba(255, 255, 255, 0.96)",
    footerBackground: "#f8fafc",
  },
