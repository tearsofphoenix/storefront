...
const OrderCard = ({ order }: OrderCardProps) => {
  ...
  const latestFulfillment = useMemo(() => {
    return getLatestOrderFulfillment(order)
  }, [order])

  const latestLabel = useMemo(() => {
    return getPrimaryFulfillmentLabel(latestFulfillment)
  }, [latestFulfillment])
          ...
          <span data-testid="order-latest-fulfillment">
            ...
            {latestFulfillment.delivered_at
              ...
              : latestFulfillment.shipped_at
                ? ` · ${new Date(latestFulfillment.shipped_at).toLocaleDateString()}`
                : ""}
          </span>
